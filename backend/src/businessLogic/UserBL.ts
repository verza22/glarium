...
export class UserBL {
    static async updateResources(authId: number)
    {
    ...
    static async updateGold(authId: number, userResource: UserResource, diffTime: number)
    {
    ...
    static async updateResearchPoint(authId: number, userResource: UserResource, diffTime: number)
    {
    ...
    static async newPlayer(userId: number) {
        ...
        await prisma.userResource.create({ data: { 
            userId,
            gold: 200,
            researchPoint: 0,
            tradeShip: 0,
