...
export default function Reducers({ buildingId, level }: Props) {
    ...
    const dataBuilding: ReducerItem[] = [
        ...
        { name: t(`buildings.${buildingId}.name`)+` (${level}%)`, per: level, per2: 96 }
    ]
        ...
        <div className="text-sm">
            <div>
                <div className="text-center font-semibold mb-3">
                    {t('modal.building.buildingReducer.building')}
                </div>
                ...
                {/* <div className="text-center font-semibold mb-3 mt-4">
                    {t('modal.building.buildingReducer.unit')}
                </div>
                ...
                <div className="flex my-2 items-center">
                    <div className="flex-2 flex items-center">- ({level}%)</div>
